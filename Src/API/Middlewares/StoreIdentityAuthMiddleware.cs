...
{
    public class StoreIdentityAuthMiddleware
    {
        private readonly RequestDelegate _next;

        public StoreIdentityAuthMiddleware(RequestDelegate next)
        {
            _next = next;
        }

        public async Task InvokeAsync(HttpContext context, CrmDbContext _crmDbContext, IdentityDbContext _identityDbContext)
        {
