...
{
  public class EposTransactionLineConfiguration : IEntityTypeConfiguration<EposTransactionLine>
  {
    public void Configure(EntityTypeBuilder<EposTransactionLine> builder)
    {
        ...
        builder.HasOne(l => l.EposTransactionHeader).WithMany(h => h.EposTransactionLines).HasForeignKey(l => l.HeaderId);
    }
  }
}