...
{
  public class EposTransactionHeaderConfiguration : IEntityTypeConfiguration<EposTransactionHeader>
  {
    public void Configure(EntityTypeBuilder<EposTransactionHeader> builder)
    {
        ...
        builder.HasMany(h => h.EposTransactionLines).WithOne(l => l.EposTransactionHeader).OnDelete(DeleteBehavior.Restrict);
    }
  }
}